...
def getstddv(path):
    ...
    mean , stddv = cv2.meanStdDev(img_hsv)
    #print(mean,stddv)
    return mean,stddv
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.hidden1=torch.nn.Linear(3,6)
        self.hidden2 = torch.nn.Linear(6, 12)
        self.hidden3 = torch.nn.Linear(12, 24)
        self.predict=torch.nn.Linear(24,1)
